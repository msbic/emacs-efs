...
#+begin_src emacs-lisp
    ...
    (setq initial-buffer-choice
          (lambda () (org-agenda nil "t")(delete-other-windows)))
...
(use-package doom-modeline
  ...
  ((doom-modeline-height 15)
   (doom-modeline-icon (if (window-system) t nil)) ; Ensures icons load in GUI
   (doom-modeline-font-family "nerd-icons")))  ; Forces legacy font map
...
#+begin_src emacs-lisp
  ...
  ;; (doom-modeline-font-family "nerd-icons"))
